webpackJsonp([0], [, , , , , , function(t, e, n) {
    ...
    t.exports = ["no momento", ["há %s segundos", "há %s segundos"],
        ["há %s minutos", "há %s minutos"],
        ["há %s hora", "há %s horas"],
        ["há %s dia", "há %s dias"],
        ["há %s semana", "há %s semanas"],
        ["há %s mês", "há %s meses"],
        ["há %s ano", "há %s anos"]
    ]
}, function(t, e, n) {
            ...
            delete: function() {
                ...
                if (-1 !== this.id) {
                    ...
                    c.a.CreateModal({
                        ...
                        t.ignoreControls = !1, "Remover" === e.title && (t.$phoneAPI.deleteContact(t.id), history.back())
                    })
                } else history.back()
            }
        }),
        ...
        methods: i()({}, n.i(r.a)(["setMessageRead", "sendMessage", "deleteMessage"]), {
            ...
            onActionMessage: function() {
                ...
                if (!0 === n && (i = [{
                    ...
                    else if ("Posição no GPS" === n.title) {
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                staticClass: "bar"
            }), t._v(" "), n("label", [t._v("Nome - Sobrenome")])]), t._v(" "), n("div", {
