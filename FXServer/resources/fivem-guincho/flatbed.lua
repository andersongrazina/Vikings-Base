...
AddTextEntry(controllerMessageLoweredCar, "Pressione ~INPUT_CONTEXT~ para ~y~subir ~w~a prancha.~n~Pressione ~INPUT_DETONATE~ para ~r~desprender ~w~o veículo.")
AddTextEntry(controllerMessageLoweredNoCar, "Pressione ~INPUT_CONTEXT~ para ~y~subir ~w~a prancha.~n~Pressione ~INPUT_DETONATE~ para ~r~prender ~w~o veículo.")
AddTextEntry(controllerMessageRaised, "Pressione ~INPUT_CONTEXT~ para ~y~abaixar ~w~a prancha.")
