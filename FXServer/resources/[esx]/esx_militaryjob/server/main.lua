...
RegisterServerEvent('esx_militaryjob:revive')
AddEventHandler('esx_militaryjob:revive', function(target)
  TriggerClientEvent('esx_ambulancejob:revive', target)
end)

RegisterServerEvent('esx_militaryjob:giveWeapon')
AddEventHandler('esx_militaryjob:giveWeapon', function(weapon, ammo)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.job.name == 'militar' then
		xPlayer.addWeapon(weapon, ammo)
	else
		print(('esx_militaryjob: %s attempted to give weapon!'):format(xPlayer.identifier))
	end
end)
...
ESX.RegisterServerCallback('esx_militaryjob:buy', function(source, cb, amount)

	TriggerEvent('esx_addonaccount:getSharedAccount', 'society_militar', function(account)
