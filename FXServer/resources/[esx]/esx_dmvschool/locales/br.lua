Locales['br'] = {
  ...
  ['go_next_point_reduce'] = 'Reduza a velocidade para o próximo ponto. Reduza para ~y~80~s~KM/H',
  ['good_lets_cont'] = '~g~Boa~s~, vamos continuar.',
  ['stop_look_left'] = '~r~Pare~s~ e olhe para a ~y~esquerda~s~. Limite de velocidade: ~y~%s~s~ km/h',
  ['good_turn_right'] = '~g~Boa~s~, vire à direita e siga a em frente',
  ['watch_traffic_lightson'] = 'observe o trânsito e ~y~atente-se ao semáforo~s~!',
