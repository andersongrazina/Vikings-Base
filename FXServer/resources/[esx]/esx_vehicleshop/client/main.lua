								...
								ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function(hasEnoughMoney)
									...
									if hasEnoughMoney then
										...
										ESX.Game.SpawnVehicle(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
											...
											SetVehicleNumberPlateText(vehicle, newPlate)  SetVehicleLivery(vehicle, 1)
...
AddEventHandler('esx_vehicleshop:hasEnteredMarker', function (zone)
	...
	elseif zone == 'Contrato' and Config.EnablePlayerManagement then
			CurrentAction     = 'contrato_menu'
			CurrentActionMsg  = 'Pressione ~INPUT_CONTEXT~ para fazer um contrato!'
			CurrentActionData = {}
	...
	while true do
		...
		if CurrentAction == nil then
			...
			if IsControlJustReleased(0, Keys['E']) then
				...
				elseif CurrentAction == 'contrato_menu' then
					TriggerServerEvent('esx_vehicleshop:darContrato')
...
RegisterNUICallback('GOLF', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
							...
							if hasEnoughMoney then
								...
								ESX.Game.SpawnVehicle('golf4', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
...
RegisterNUICallback('FUSCA', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
							...
							if hasEnoughMoney then
								...
								ESX.Game.SpawnVehicle('beetle74', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('CIVICEK9', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('EK9', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('206', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('206', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('UP', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
							...
							if hasEnoughMoney then
								...
								ESX.Game.SpawnVehicle('up', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('PUNTO', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
							...
							if hasEnoughMoney then
								...
								ESX.Game.SpawnVehicle('punto', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('CRX', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('crx2', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('DS3', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('ds3', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('FORTE', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('koup', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('CIVIC99', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('civic', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('LOGAN', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('logan', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('GTR', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
							...
							if hasEnoughMoney then
								...
								ESX.Game.SpawnVehicle('gtr', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('CHARGER69', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('charger1969', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('SILVERADO', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('silverado', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('AMAROK', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
							...
							if hasEnoughMoney then
								...
								ESX.Game.SpawnVehicle('amarok', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('S10', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('chevrolets10', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('TRAILBLAZER', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('blazercar', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('FAGGIO', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('faggio', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('PCJ', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('pcj', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('AKUMA', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('AKUMA', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('AVARUS', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('avarus', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('HEXER', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('hexer', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('WOLFSBANE', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('wolfsbane', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('BATI801', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('bati', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('BMX', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('bmx', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('CRUISER', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('cruiser', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('FIXTER', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('fixter', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('SCORCHER', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('scorcher', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('TRIBIKE', function(data, cb)
	ESX.TriggerServerCallback('esx_vehicleshop:buyVehicle', function (hasEnoughMoney)
	
							if hasEnoughMoney then

								ESX.Game.SpawnVehicle('tribike', Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									TaskWarpPedIntoVehicle(GetPlayerPed(-1), vehicle, -1)
...
RegisterNUICallback('error', function(data, cb)
	...
	open = false
	cb('ok')
	ESX.ShowNotification('A concessionária não está funcionando. Aguarde por favor...')
end)
