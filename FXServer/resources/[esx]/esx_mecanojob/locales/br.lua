Locales['br'] = {
  ...
  ['open_actions']              = 'Pressione ~INPUT_CONTEXT~ para acessar menu.',
  ['harvest']                   = 'Processando',
  ['harvest_menu']              = 'Pressione ~INPUT_CONTEXT~ para acessar o menu de processamento.',
  ...
  ['craft']                     = 'Construir',
  ['craft_menu']                = 'Pressione ~INPUT_CONTEXT~ para acessar menu de criar feramentas.',
  ['billing']                   = 'Faturamento',
  ['hijack']                    = 'Destrancar',
  ['repair']                    = 'Reparar',
  ['clean']                     = 'Limpar',
  ...
  ['recovery_gas_can']          = '~b~Lata de gâs~s~ fabricando...',
  ['recovery_gps_can']          = '~b~GPS~s~ fabricado...',
  ['recovery_nitro_can']          = '~b~Nitro~s~ fabricado...',
  ['recovery_repair_tools']     = '~b~Ferramentas de reparo~s~ fabricando...',
  ['gps_recovery']              = '~b~GPS~s~ fabricando...',
