...
Config.DoorList = {
	...
	
	{
		...
		textCoords = {x = -843.051, y = 159.9619, z = 68.15221},
	...
	
	{
		...
		textCoords = {x = -848.3843, y = 178.5879, z = 70.3247},
		authorizedJobs = { 'mafia' },
		locked = true,
		distance = 2.5
	},
--[[
	{
		...
		textCoords = {x = -59.89302, y = -1092.952, z = 26.88362},
	...
	
	{
		...
		textCoords = {x = -60.54582, y = -1094.749, z = 26.88872},
		authorizedJobs = { 'cardealer' },
		locked = true,
		distance = 2.5,
		size = 2
	...
	{
		objName = 'v_ilev_csr_door_r',
		objCoords  = {x = -37.33113, y = -1108.873, z = 26.7198},
		textCoords = {x = -37.33113, y = -1108.873, z = 26.7198},
		authorizedJobs = { 'cardealer' },
		locked = true,
		distance = 2.5,
		size = 2
	...
	{
		objName = 'v_ilev_csr_door_l',
		objCoords  = {x = -39.13366, y = -1108.218, z = 26.7198},
		textCoords = {x = -39.13366, y = -1108.218, z = 26.7198},
		authorizedJobs = { 'cardealer' },
		locked = true,
		distance = 2.5,
		size = 2
	...
	
	{
		...
		objCoords  = {x = -30.8195, y = -1086.05481, z = 27.6247501},
		textCoords = {x = -30.8195, y = -1086.05481, z = 27.6247501},
		authorizedJobs = { 'cardealer' },
		locked = true,
		distance = 5.5
	},
