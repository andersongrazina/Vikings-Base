Locales['br'] = {
  ...
  ['spawn_heli'] = 'Pressione ~INPUT_CONTEXT~ para solicitar um helicóptero!',
  ...
  -- Service
  ['service_max'] = 'Você não pode ~y~entrar em serviço, máximo de policiais em serviço: %s/%s',
  ...
  ['service_in_announce'] = 'operador ~y~%s~s~ ~y~entrou em serviço!',
  ['service_out'] = 'Você saiu de serviço.',
  ['service_out_announce'] = 'operador ~y~%s~s~ saiu de serviço.',
  -- Action Menu
  ...
  ['license_check'] = 'Gerenciar licenças',
  ['license_revoke'] = 'Remover Licenças',
