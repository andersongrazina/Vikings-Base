...
RegisterServerEvent('esx_policejob:congelarOperacoes')
AddEventHandler('esx_policejob:congelarOperacoes', function(target)
	local xPlayer = ESX.GetPlayerFromId(target)

	if xPlayer then
		xPlayer.setJob('unemployed', 0)
		MySQL.Async.execute('UPDATE users SET job = "unemployed" WHERE job = @job',
		{
