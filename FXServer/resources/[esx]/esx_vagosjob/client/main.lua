...
function OpenCloakroomMenu()
	...
	elseif grade == 'soldado' then
		table.insert(elements, {label = _U('vagos_wear'), value = 'soldado_wear'})
...
function GetAvailableVehicleSpawnPoint(station, partNum)
	local spawnPoints = Config.VagosStations[station].Vehicles[partNum].SpawnPoints
...
function OpenGetStocksMenu()
	...
	ESX.TriggerServerCallback('esx_vagosjob:getStockItems', function(inventory)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_vagosjob:getStockItem', data.current.type, itemName, count)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_vagosjob:putStockItems', data.current.type, itemName, count)
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'vagos' then
		...
		if IsControlJustReleased(0, Keys['F6']) and not isDead and PlayerData.job ~= nil and PlayerData.job.name == 'vagos' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'vagos_actions') then
			if Config.MaxInService == -1 then
