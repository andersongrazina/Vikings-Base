...
RegisterServerEvent('eden_garage:paymecano')
...
AddEventHandler('eden_garage:paymecano', function()

	local xPlayer = ESX.GetPlayerFromId(source)

	xPlayer.removeMoney(Config.Price)

	TriggerClientEvent('esx:showAdvancedNotification', source, 'Mecânico', 'Solicitação de Veículo', 'Você solicitou um veículo. Dentro de 9 Segundos entregaremos para você!', 'CHAR_BIKESITE', 2)
