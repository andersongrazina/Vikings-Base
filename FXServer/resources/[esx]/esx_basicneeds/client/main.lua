...
AddEventHandler('esx_status:loaded', function(status)
	...
	TriggerEvent('esx_status:registerStatus', 'hunger', 1000000, '#FFC107', -- amarelo
	...
	TriggerEvent('esx_status:registerStatus', 'thirst', 1000000, '#007BFF', -- azul
...
RegisterNetEvent('esx_basicneeds:onDrinkCola')
...
RegisterNetEvent('esx_basicneeds:onDrinkLeiteP')
AddEventHandler('esx_basicneeds:onDrinkLeiteP', function(prop_name)
	if not IsAnimated then
...
RegisterNetEvent('esx_basicneeds:onDrinkLeiteG')
AddEventHandler('esx_basicneeds:onDrinkLeiteG', function(prop_name)
	if not IsAnimated then
