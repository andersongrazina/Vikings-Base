Locales['br'] = {
  ['by_default'] = 'padrão',
  ['installed'] = 'instalado',
  ['already_own'] = 'já possui: ~b~%s~s~',
  ['not_enough_money'] = 'sem dinheiro!',
  ['purchased'] = 'você comprou esta peça!',
  ['press_custom'] = 'pressione ~INPUT_PICKUP~ para personalizar o veiculo.',
  ['level'] = 'level %s',
  ['neon'] = 'neon',
