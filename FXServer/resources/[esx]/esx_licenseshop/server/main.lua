...
-- Aircraft License
RegisterServerEvent('esx_licenseshop:buyPlanodeSaude')
AddEventHandler('esx_licenseshop:buyPlanodeSaude', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.get('money') >= Config.PlanodeSaudeLicensePrice then
		xPlayer.removeMoney(Config.PlanodeSaudeLicensePrice)

		TriggerEvent('esx_license:addLicense', _source, 'planosaude', function()
			LoadLicenses(_source)
		end)
	else
...
RegisterServerEvent('esx_licenseshop:pagarTaxa')
AddEventHandler('esx_licenseshop:pagarTaxa', function()
	local xPlayer = ESX.GetPlayerFromId(source)
