...
Config.Zones = {
	...
	VehicleSpawner = {
		...
		hint 		= 'Pressione ~INPUT_CONTEXT~ para tirar o veículo da garagem.',
	},
	...
	VehicleDeleter = {
		...
		BlipSprite 	= 67,
		BlipColor 	= 52,
		BlipName 	= Config.nameJobLabel.." : Guardar veículo",
		hint 		= 'Pressione ~INPUT_CONTEXT~ para guardar o veículo.',
	},
	...
	Sell = {
		...
		BlipSprite			= 67,
		BlipColor 			= 52,
		BlipName 			= Config.nameJobLabel.." : Depósito",

		ItemTime 			= 500,
		ItemDb_name 		= "sacbillets",
		ItemName 			= "Saco de Dinheiro",
		ItemMax 			= 100,
		ItemAdd 			= 1,
		ItemRemove 			= 1,
		ItemRequires 		= "sacbillets",
		ItemRequires_name 	= "Saco de Dinheiro",
		ItemDrop 			= 100,
		ItemPrice			= 250,
		hint 				= 'Pressione ~INPUT_CONTEXT~ para esvaziar os sacos de dinheiro.',
	},
}
