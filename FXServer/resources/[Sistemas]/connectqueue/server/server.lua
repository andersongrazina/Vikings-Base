...
Config.Priority = {
    ["STEAM_0:1:#######"] = 50,
	["steam:11000013bd8a1c5"] = 50,
	["steam:110000101197a44"] = 50,
    ["steam:1100001128b7f4b"] = 100,
    ["ip:127.0.0.0"] = 85
}
...
-- easy localization
Config.Language = {
    joining = "Juntando-se ao servidor...",
    connecting = "Conectando ao servidor...",
    idrr = "Erro: Não foi possível encontrar nenhum dos seus SteamIDs, tente reiniciar o fivem com a steam aberta!",
    err = "Ocorreu um erro!",
    pos = "[Fila Automática] Você está em %d/%d na fila",
    connectingerr = "Erro ao adicionar você à fila de conexão",
    timedout = "Ping de conexão?",
    wlonly = "Você precisa estar na whitelist para entrar neste servidor",
    banned = "Você está banido | razão: %s",
    steam = "Erro: a Steam deve estar aberta!"
}
-----------------------------------------------------------------------------------------------------------------------
