...
Citizen.CreateThread(function()
	while true do
		...
		local cantinhodonego = GetPedParachuteState(GetPlayerPed(-1))

		if DoesEntityExist(ped) and not IsEntityDead(ped) and not IsPedInAnyVehicle(ped, true) and cantinhodonego ~= 2 then
