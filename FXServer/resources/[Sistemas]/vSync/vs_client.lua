...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/weather', 'Mudar o clima.', {{ name="weatherType", help="Tempos disponíveis: extrasunny, clear, neutral, smog, foggy, overcast, clouds, clearing, rain, thunder, snow, blizzard, snowlight, xmas & halloween"}})
    TriggerEvent('chat:addSuggestion', '/time', 'Mudar o horário.', {{ name="hours", help="A number between 0 - 23"}, { name="minutes", help="A number between 0 - 59"}})
