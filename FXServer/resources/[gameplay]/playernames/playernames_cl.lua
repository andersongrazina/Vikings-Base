...
RegisterCommand("idon", function(source, args, raw)
	draw = true
	updatePlayerNames()
end, false)

RegisterCommand("tirarid", function(source, args, raw)
	draw = false
	updatePlayerNames()
end, false)
...
function updatePlayerNames()
    ...
    for i = 0, 255 do
        ...
        if NetworkIsPlayerActive(i) and i ~= PlayerId() then
            ...
            if distance < 7.5 and HasEntityClearLosToEntity(PlayerPedId(), ped, 17) and draw == true then
